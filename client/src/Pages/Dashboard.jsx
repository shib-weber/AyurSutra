    ...
    return (
        ...
        <div className="flex h-full grow">
            ...
            <main className="flex-1 overflow-y-auto bg-[var(--c-bg-primary)] p-8">
                ...
                <h1 className="text-3xl font-bold text-[var(--c-text-primary)]">Dashboard</h1>
                ...
                <div className="flex flex-col gap-4">
                    <h2 className="text-2xl font-bold text-[var(--c-text-primary)]">Upcoming Appointments</h2>
                    <AppointmentsTable />
                </div>
                <div className="flex flex-col gap-4">
                    <h2 className="text-2xl font-bold text-[var(--c-text-primary)]">Recent Activities</h2>
                    <RecentActivities />
                </div>
                </div>
            </main>
